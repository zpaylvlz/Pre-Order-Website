    ...
    <form id="form1" runat="server">
        <table style="width:100%;">
            <tr>
                ...
                <td style="width:50%;border-color:#000000;border-style:solid;border-radius:10px;background-color:navy">
                    <div class ="Tit" style="width:100%;font-size:48px;background-color:navy;
                         font-family:'Microsoft JhengHei';color:white">登入</div>
                </td>
                <td style="width:25%"></td>
            </tr>
        </table>
