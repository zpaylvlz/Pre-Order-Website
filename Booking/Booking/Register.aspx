...
<body style="background-color:bisque">
    ...
    <form id="form1" runat="server">
        ...
        <td colspan="3" style="width:70%;height:80px;border-color:#000000;border-style:solid;background-color:navy;
            border-top-left-radius:10px;border-top-right-radius:10px;">
            <b style="font-size:28px;font-family:'Microsoft JhengHei';color:white">註冊帳號</b>
